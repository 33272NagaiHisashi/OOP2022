...
namespace DataBaseSample {
	public partial class btConnect : Form {
		...
		private void button1_Click(object sender, EventArgs e) {
			// TODO: このコード行はデータを 'infosys202232DataSet.社員' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
			this.社員TableAdapter.Fill(this.infosys202232DataSet.社員);
		}
		...
		private void btSave_Click(object sender, EventArgs e) {
			...
			this.社員BindingSource.EndEdit();
			this.tableAdapterManager.UpdateAll(this.infosys202232DataSet);
			//this.社員TableAdapter.Update(this.infosys202232DataSet.社員);
		}
